    ...
    <div v-if="filteredAndSortedCourses.length" class="grid gap-6">
      <div v-for="course in filteredAndSortedCourses" :key="course.course_code"
        ...
        <div class="flex-1">
          ...
          <!-- Progress bar -->
          <!-- <div class="bg-gray-200 h-3 rounded-full mt-2">
          ...
          <div v-show="true" class="flex flex-wrap gap-3 mt-4">
            <!-- Edit Course Button -->
            <button
            ...
            <button
              class="inline-flex items-center gap-2 bg-gray-500 text-white px-4 py-1.5 rounded-lg hover:bg-gray-700 transition"
              @click.stop="viewAssignments(course)">
              Assignments
            </button>
      ...
      <div v-if="selectedCourse" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4"
        ...
        <div class="relative bg-white w-full max-w-6xl max-h-[90vh] overflow-y-auto rounded-2xl shadow-2xl">
          ...
          <div class="p-6">
            ...
            <CourseEdit v-if="activeModal === 'edit'" :show=true @close="closeModal" />

            <!-- Add Assignment Component -->
            <AssignmentView v-if="activeModal === 'assignment'" :coursecode="selectedCourse.course_code"
