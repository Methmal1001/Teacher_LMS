            ...
            <div class="p-6 sm:p-8 space-y-7">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Janitha Pushpakumara"
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="ICT"
                            class="w-full px-4 py-2.5 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none" />
                    </div>
                    <!-- Module -->
                    <div>
                        ...
                        <input type="text" placeholder="Logic Gates"
                            class="w-full px-4 py-2.5 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none" />
                    </div>
                    <!-- Assignment Name -->
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="MCQ"
                            class="w-full px-4 py-2.5 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none" />
                    </div>
                    <!-- Passing Score -->
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="60 minutes"
                            class="w-full px-4 py-2.5 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none" />
                    </div>
                    <!-- Due Date -->
                    <div>
