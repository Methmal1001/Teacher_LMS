    ...
    <div>
      ...
      <form @submit.prevent="handleSubmit" class="p-6 sm:p-8 space-y-7">
        ...
        <div>
          ...
          <button type="button" class="px-3 py-1 rounded-xl bg-green-600 text-sm text-white hover:bg-green-700 mb-2">
            Add new +
          </button>
          <div class="relative grid grid-cols-1 md:grid-cols-3 gap-4 border border-1 p-2 mb-1">
            <!-- Close button -->
            <button type="button" @click="closeModalOrResetForm"
              class="absolute top-2 right-3 p-0.25 bg-red-500 rounded-full text-gray-100 hover:bg-red-700 focus:outline-none"
              title="Close">
